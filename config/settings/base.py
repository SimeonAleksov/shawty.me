...
)  # (shawty_/config/settings/base.py - 3 = shawty_/)
APPS_DIR = ROOT_DIR.path("shawty_")
...
LOCAL_APPS = [
    "shawty_.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "shawty_.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "shawty_.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "shawty_.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "shawty_.users.adapters.SocialAccountAdapter"
...
GRAPHENE = {
    "SCHEMA": "shawty_.graphql.schema.schema",
